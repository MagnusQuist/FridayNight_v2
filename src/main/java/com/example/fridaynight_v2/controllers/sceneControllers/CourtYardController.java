...
public class CourtYardController implements Initializable {
    ...
    public void AddCollectables() {
        // Add Scene Fact
        items.add(new Fact("Sundhedsstyrelsen anbefaler, at især unge passer på hvor store mængder alkohol ved én " +
                "lejlighed, og hvor ofte de drikker. Store mængder alkohol kan hæmme udviklingen af hjernen hos unge, " +
                "og der er også observeret en forhøjet risiko for hjerneskader blandt unge der drikker alkohol. Desuden " +
                "er der påvist en sammenhæng mellem påbegyndelse af et stort alkoholforbrug i ungdommen og afhængighed " +
                "senere i livet.", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));

        items.add(new Fact("Vidste du at… Der er mange årsager til at folk udvikler problemer med alkohol. " +
                "En vigtig del af det skyldes genetik. Forskere mener, at 50% af årsagen bag alkoholproblemer " +
                "skyldes genetik. ", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));
