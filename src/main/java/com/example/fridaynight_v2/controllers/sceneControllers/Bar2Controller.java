...
public class Bar2Controller implements Initializable {
    ...
    public void AddCollectables() {
        // Add Scene Fact
        items.add(new Fact("Vidste du at… De danske unge er dem, der drikker mest af de europæiske unge. " +
                "Med det store alkoholforbrug er det klart at mange kommer galt afsted på grund af alkohol. " +
                "Bl.a. har 31% af de danske unge oplevet at være ude for en selvforskyldt ulykke (f.eks. væltet " +
                "på cykel, faldet) pga. alkohol", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));
