...
public class DanceFloorController implements Initializable {
    ...
    public void gotoCourtYard(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(Main.class.getResource("view/courtyard.fxml"));
        root = loader.load();
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        CourtYardController controller = loader.getController();
    ...
    public void AddCollectables() {
        // Add Scene Fact
        items.add(new Fact("Vidste du at… alkohol øger din risiko for at få kræft. Der findes ingen sikker mængde " +
                "alkohol, fordi selv den mindste smule alkohol øger kræftrisikoen.",
