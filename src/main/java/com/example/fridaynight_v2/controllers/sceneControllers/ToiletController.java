...
public class ToiletController implements Initializable {
    ...
    public void AddCollectables() {
        // Add Scene Fact
        items.add(new Fact("Vidste du at… Ca. 3 millioner mennesker dør hvert år af alkoholrelaterede årsager på " +
                "verdensplan. Det svarer til omkring 5,3%", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));

        items.add(new Fact("Vidste du at… det estimeres at alkohol er involveret i mere end 80% af alle " +
                "ulykker og selvmord blandt unge", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));
