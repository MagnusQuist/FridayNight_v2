...
public class WardrobeController implements Initializable {
    ...
    public void GoToBar1(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(Main.class.getResource("view/bar1.fxml"));
        root = loader.load();
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        Bar1Controller controller = loader.getController();
    ...
    public void AddCollectables() {
        // Add Scene Fact
        items.add(new Fact("Vidste du at… Du har lav risiko for at blive syg af alkohol hvis du som kvinde drikker " +
                "mindre end 7 genstande og som mand drikker mindre end 14 genstande på en uge. " +
                "Du har derimod høj risiko for at blive syg af alkohol, hvis du drikker mere end 14 og 21 genstande " +
                "om ugen henholdsvis for kvinder og mænd.", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));

        items.add(new Fact("Vidste du at… Alkohol er forbundet med omkring 60 forskellige sygdomme, herunder " +
                "leversygdomme, hjertesygdomme og kræft", (int)(1+(Math.random() * (11 - 2))) , (int)(1+(Math.random() * (11 - 2)))));
        ...
        for (int i = 0; i < (int)(1+(Math.random() * (3 - 1))); i++) {
            Collectable item = new Collectable(0.1, "Clock", (int)(1+(Math.random() * (11 - 2))) ,
